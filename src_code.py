...
os.environ['KAGGLE_CONFIG_DIR'] = 'C:/Users/rammp/.kaggle'  # Update this path to your Kaggle configuration directory

# Specify the dataset identifier
dataset = 'piterfm/paris-2024-olympic-summer-games'

# Set the download path
download_path = 'C:/Users/rammp/OneDrive/Desktop/Project/Olympics 2024 Dashboard/Source' # Change this to your preferred download directory
